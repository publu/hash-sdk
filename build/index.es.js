...
import { ContractFunctionParams, Client, Ed25519PrivateKey, FileCreateTransaction, FileAppendTransaction, ContractCreateTransaction, CryptoTransferTransaction, Status, ContractExecuteTransaction, FileContentsQuery, ConsensusTopicCreateTransaction, KeyList, Ed25519PublicKey, ConsensusTopicId, ConsensusTopicUpdateTransaction, ConsensusTopicInfoQuery, ConsensusTopicDeleteTransaction, ConsensusSubmitMessageTransaction } from '@hashgraph/sdk';
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                id = new ConsensusTopicId(topicId);
                return [4 /*yield*/, new ConsensusSubmitMessageTransaction()
                        .setTopicId(id)
                        .setMessage(message)
...
window.hash = __assign({}, exports);
// Exposing function using default
var index = __assign({}, exports);
